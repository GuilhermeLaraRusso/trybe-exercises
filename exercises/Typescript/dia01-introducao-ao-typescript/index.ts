...
console.log(`- Trapézio de base maior 100cm, base menor 70cm e altura 50cm: ${Ex.getTrapezeArea(50, 100, 70)}cm²`);
console.log(`- Trapézio de base maior 75cm, base menor 50cm e altura 35cm: ${Ex.getTrapezeArea(35, 75, 50)}cm²`);
console.log(`- Trapézio de base maior 150cm, base menor 120cm e altura 80cm: ${Ex.getTrapezeArea(80, 150, 120)}cm²`);
...
console.log(`- Retângulo de base 10cm e altura de 25cm: ${Ex.getPolygonPerimeter([10, 25, 10, 25])}cm`);
