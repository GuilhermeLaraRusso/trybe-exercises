...
const create = rescue(async (req, res, next) => {
  ...
  // Caso exista algum problema com a valização, iniciamos o fluxo de erro e interrompemos o middleware.
  if (error) {
    return next(error);
  }
  ...
  // Caso esteja tudo certo, retornamos o status 201 Created, junto com a s informações
...
const findById = rescue(async (req, res, next) => {
  ...
  // Caso não haja nennhum erro, retornamos o author encontrado
